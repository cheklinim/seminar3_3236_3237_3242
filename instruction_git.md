...
Теперь для того чтобы начать вносить изменения создаем новую ветку и переходим в нее, используя 
команды: git branch branch_name и git checkout branch_name

Файл готов для работы.

Все изменения делаем исключительно в новой созданной ветке.

#### Как отправить изменения владельцу репозитория

1. с помощью команды git push направляем репозиторий сначала в свой аккаунт
2. при помощи кнопки pull request направляем информацию владельцу репозитория
