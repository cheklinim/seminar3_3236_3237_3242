...
Для того, чтобы залить и отобразить все изменения, которые вы сделали в удаленном репозитории, в локальный репозиторий, необходимо использовать команду:

    git pull

### Работа с чужими репозиториями

Если вы хотите поработать с чужим репозиторием и предложить ему изменения, необходимо сделать следующее:

1. На GitHub находите необходимого пользователя и выбираете нужный репозиторий
2. Нажимаете на кнопку "Fork", что позволяет создать копию данного репозитория в вашем аккаунте
3. Клонируете репозиторий (если вы будете работать на локальном ПК)
4. Создаете новую ветку и в **нее** вносите свои изменения
5. Отправляете свою версию на GitHub
6. На сайте GitHub нажимаете кнопку "Pull request"
