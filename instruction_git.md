...
## Размещение измменений/дополнений в "чужом" репозитории автором "чужого" репозитория

После внесения изменений/дополнений в "чужом" репозитории, мы должны разместить/отправить свои правки автору "чужого" (копированного) репозитория, для этого можно воспользоваться командой:

    pull request

**Но** сначало необходимо воспользоваться командой **git push** (выгрузка своего локального репозитория в свой удаленный репозиторий)

Происходит выгрузка локального репозитория в удаленный репозиторий на сайт GitHub, в ккаунте появятся все изменения, все можно просмотреть. 

справой стороны будет зеленая кнопка **Compare pull request**, при нажатии на которую возникнет диалоговое окто, в котором можно оставить пояснения для авторого "чужого" репозитория и нажимаем кнопку отправить.

### **ВАЖНО**

1. чаще делать commit;
2. незабывать переходить с ветки на ветку;
3. комиты должны быть максимально понятные для всез, не только для автора комита;