...
## Копирование (через _Fork_) внешнего (удаленного) репозитория в локальный репозиторий и работа с ним: 

1. Необходимо зайти во внешний аккаунт через ***github*** и выделить необходимый репозиторий для копирования. 

2. Через закладку _Fork_ в ***github*** выбранный репозиторий копируется в ваш репозиторий на ***github** с таким же названием и указанием другого логина в названии репозитория. 

3. В VSC необходимо создать новую локальную папку.

4. Для копирования из удаленного репозитория на ***github** в локальный репозиторий, используется команда:

git clone <ссылка на репозиторий>

ссылка находится во вкладке _Сode_ репозитория
...
5. Для работы с внешним репозиторием необходимо создать новую ветку.

6. Для внеснения изменений во внешний репозиторий необходимо их направить на ваш удаленный репозиторий (команда git push).
