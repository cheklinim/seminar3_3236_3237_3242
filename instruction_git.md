...
Для добавления изменений, внесенных в локальный репозиторий в удаленный репозиторий, необходимо воспользоваться командой:
...
Для добавления изменений, внесенных на удаленном репозитории в локальный репозиторий, необходимо воспользоваться командой:
...
При этом, при первой попытке сделать таким образом репозиторий, программа потребует авторизацию. После чего на странице GitHub появиться новый репозиторий.